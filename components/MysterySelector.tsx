...
const mysteries: Mystery[] = [
	{
		...
		description:
			"A wealthy estate owner has been found dead. Multiple suspects with secrets. Can you uncover the truth?",
	...
	},
	{
		...
		description:
			"An artist reports a break-in, but nothing was stolen. Something more sinister lurks beneath the surface.",
	...
	},
	{
		...
		description:
			"A priceless ruby has vanished from a secure museum vault. Inside job or masterful theft?",
			...
			<div className="w-full max-w-6xl">
				<div className="mb-12 text-center">
					...
					<p className="text-lg text-muted-foreground">
						Solve mysteries inspired by thrillers with SQL queries
					</p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					{mysteries.map((mystery) => (
						<Card
							key={mystery.id}
							className="flex flex-col overflow-hidden hover:shadow-lg transition-shadow border-border/50"
						>
							<CardHeader>
