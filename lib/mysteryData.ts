...
export const MYSTERY_DATA: Record<string, Mystery> = {
    winchester: {
        ...
        brief: 'A prestigious estate has been thrown into chaos following the sudden death of its owner, Charles Winchester. The victim was found in the library late evening. Five individuals had access to the estate that day, each with potential motives and suspicious behavior.',
        ...
        clues: [
            ...
            },
            {
                ...
                queryKeywords: ['SELECT', 'FROM', 'evidence', 'WHERE', 'LIKE', 'venerinary'],
            },
            {
                id: 5,
                unlockLevel: 4,
        ...
        clues: [
            {
                ...
                queryKeywords: ['SELECT', 'FROM', 'evidence', 'WHERE', 'name', 'LIKE', 'window'],
            },
            {
                id: 2,
                unlockLevel: 1,
                ...
                queryKeywords: ['SELECT', 'FROM', 'evidence', 'WHERE', 'description', 'LIKE'],
            },
            {
                id: 3,
                unlockLevel: 2,
    ...
    heist: {
        ...
        clues: [
            ...
            },
            {
                ...
                queryKeywords: ['SELECT', 'FROM', 'event', 'WHERE', 'description', 'LIKE', 'vault'],
            },
            {
                id: 3,
                unlockLevel: 2,
                ...
                queryKeywords: ['SELECT', 'FROM', 'evidence', 'WHERE', 'description', 'LIKE', 'transfer'],
            },
            {
                id: 4,
                unlockLevel: 3,
                ...
                queryKeywords: ['SELECT', 'FROM', 'event', 'WHERE', 'suspect_id', 'IS NULL'],
            },
        ],
    },
};
